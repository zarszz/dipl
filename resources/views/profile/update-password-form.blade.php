<div class='card' submit="updatePassword">
    <div class="card-header">
        ...
        <p class="card-description">Pastikan password yang aman dan tidak sama seperti password sebelumnya.</p>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('user.updatePassword', ['id' => auth()->user()->id]) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input id="password" type="password"
                    class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" name="password1"
            ...
            <div class="form-group">
                ...
                <input id="password_confirmation" type="password"
                    ...
                    name="password2" wire:model.defer="state.password_confirmation" autocomplete="new-password">
                <x-maz-input-error for="password_confirmation" />
            </div>

            <button class="btn btn-primary float-end mt-2" wire:loading.attr="disabled"
                wire:target="updatePassword">Simpan</button>
        </form>
